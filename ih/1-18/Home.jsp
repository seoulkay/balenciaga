    ...
    <div class="col-md-8 blog-main">
      ...
      <!--진짜 친구리스트 시작 -->
        <div class="row" style="margin-top: 1em; padding:1em">
       	  <c:forEach items="${friendList }" var="friend" begin="0">
          <div class="col-2" style="text-align: center">
          <img src="resources/${friend.avatar} " alt="Avatar" width=60em style="border-radius: 50%; border: 3px solid #F56040; padding:2px">
            <div style="color:grey" align="center"><small>${friend.realName }</small></div>
          </div>
          </c:forEach>
        </div>
        <!-- 진짜 친구리스트 끝 -->
        ...
        <c:forEach items="${postList }" var="po" begin="0">
          <div class="card mb-4 shadow-sm">
            ...
            <div class="col-1">
              ...
              <a href="" style="color:black">&nbsp;${po.instaId }</a>
              </div>
              <div class="col-2">
               <h4>...</h4>
              </div>
            ...
            <div class="card-body">
              <div class="row">
         	  ...
         	  <p class="card-text"><strong>${po.instaId }</strong> ${po.description }</p>
			...
			<c:forEach items="${po.replyList }" var="reply" begin="0">
              <div class="row">
                <div class="col-11">
                ${reply.instaId } ${reply.description }
                </div>
                <div class="col-1">
    ...
    <aside class="col-md-4 blog-sidebar">
      <div class="p-4 mb-3 bg-light rounded">
          ...
          <div class="row" style="margin-bottom:2em">
            <div class="col-3">
              <img src="resources/${me.avatar}" alt="Avatar" width=50em style="border-radius: 50%;" class="img-fluid">
            </div>
            <div class="col-6">
              <p><strong>${me.instaId }</strong><br><small><span style="color:grey">${me.realName }</span></small></p>
            </div>
            <div class="col-3">
              <p><small><a href="">switch</a></small></p>
            </div>
          </div>
    	...
    	<!-- 추천 친구 리스트 시작 friendList -->
    	<c:forEach items="${friendList }" var="friend" begin="0">
          <div class="row" style="margin-bottom:1em">
            <div class="col-sm-3">
              <img src="resources/${friend.avatar}" alt="Avatar" width=35em style="border-radius: 50%;" class="img-fluid">
            </div>
            <div class="col-sm-6">
              <p><strong>${friend.instaId}</strong><br><small><span style="color:grey;">${friend.realName}</span></small></p>
            </div>
            <div class="col-sm-3">
              <p><small><a href="">Follow</a></small></p>
            </div>
          </div>
          </c:forEach>
		<!-- 추천 친구리스트 끝 -->
