  ...
  <header class="blog-header" style="padding:0.5em;">
    <div class="row flex-nowrap justify-content-between align-items-center">
      <div class="col-4 pt-1">
        <h2 style="font-family: 'Cookie', cursive; margin:0;"><a href="/me/" style="text-decoration:none; color:black">Instagram</a></h2>
      </div>
 ...
 <!--        <a class="text-muted" href="#" aria-label="Search">
      ...
      <div class="col-4 d-flex justify-content-end align-items-center">
       <!--  <a class="text-muted" href="#" aria-label="Search">
		...
		<a href="/me/message" style="text-decoration:none; color:black">
...
<!--       <h3 class="pb-4 mb-4 font-italic border-bottom">
 ...
 <!--        <h2 class="blog-post-title">Sample blog post</h2>
        ...
        <!-- 팔로우하고 있는 친구들 하이라이트  리스 -->  
          <c:forEach items="${followList}" var="fo" begin="0">
	          <div class="col-2" style="text-align: center">
	            <img src="resources/${fo.avatar }" alt="Avatar" width=54em style="border-radius: 50%; border:2px solid #FE4164; padding:2px">
	         	<div align="center"><small>${fo.instaId }</small></div>
	            <!--  <span style="font-size:1vw">${fo.instaId }</span>-->
	          </div>
          </c:forEach>
                      ...
                      <path fill-rule="evenodd" d="M2 2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v13.5a.5.5 0 0 1-.777.416L8 13.101l-5.223 2.815A.5.5 0 0 1 2 15.5V2zm2-1a1 1 0 0 0-1 1v12.566l4.723-2.482a.5.5 0 0 1 .554 0L13 14.566V2a1 1 0 0 0-1-1H4z"/>
          				...
          				<div class="row">
          					...
          					<div class="col-11" style="margin-top:0.4vw">
          						<strong>${po.likeInstaId }</strong>님 <strong>외 ${po.likeList.size() }명</strong>이 좋아합니다  
          					</div>
    ...
    <aside class="col-md-4 blog-sidebar">
      <div class="p-4 mb-3 bg-light rounded">
        ...
        <div class="row" style="margin-bottom:2em">
            ...
            <div class="col-3">
              <img src="resources/${me.avatar }" alt="Avatar" width=58em style="border-radius: 50%;">
            </div>

            <div class="col-6" style="margin-top:0.4em; font-size: 1rem">
              <p><strong>${me.instaId }</strong><br><span style="color:grey">${me.realName}</span></p>
            </div>

            <div class="col-3" style="margin-top:0.4em">
              <p><a href=""><strong>전환</strong></a></p>
            </div>
          </div>
        ...
        <div class="row" style="margin-bottom:2em">
          ...
          <div class="col-8"> <!--  style="font-size: 1rem">-->
            <p><strong style="color:grey">회원님을 위한 추천</strong></p>
          </div>
            
          <div class="col-4" >
            <p><small><a href="" > <!--  style="color:black; font-size: 0.9rem">--><strong>모두 보기</strong></a></small></p>
          </div>        
        </div>


		<!-- 회원님을 위한 추천 리스트 반복문 시작  -->


		<c:forEach items="${othersList}" var="oth" begin="0">
	        <div class="row" style="margin-bottom:1em">
	            <div class="col-2">
	              <img src="resources/${oth.avatar }" alt="Avatar" width=39em style="border-radius: 50%; ">
	            </div>
	            <div class="col-7">
	              <strong>${oth.instaId }</strong><br><span style="color:grey; font-size:1vw">${oth.description }</span>
	            </div>
	            <div class="col-3">
	              <a href="" style=" font-size:1vw"><strong>팔로우</strong></a>
	            </div>
	        </div>
		</c:forEach>

		<!-- 회원님을 위한 추천 리스트 반복문 끝  -->
