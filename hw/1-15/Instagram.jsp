            ...
            <div class="card mb-4 shadow-sm">
              <div class="row">
                <div class="col-1" style="padding:1em">
                  <img src="resources/img_avatar.png" alt="Avatar" width=40em style="margin-left:1em; border-radius: 50%; border:2px solid #FE4164; padding:2px">
                </div>
                <div class="col-9" style="margin-top:1.3em;">
                  <a href="" style="color:black">&nbsp;
                  <strong>jeju_island</strong></a>
                </div>
              ...
              <img width="100%" src="resources/insta01.png">
              ...
              <div class="card-body">
                ...
                <p class="card-text" style="margin-top:0.7em">
                  <strong>좋아요 2,976개</strong>
                  <br>
                  <br>
                  <strong>jeju_island</strong>
                  &nbsp;This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer. <a href="">#visit #jeju</a>...<a class="text-muted">더 보기</a> 
                  <br>
                  <a class="text-muted">댓글 75개 모두 보기</a>
                  <br>
                  <strong>love_korea1004</strong>&nbsp;넘나 가고파...
                  <br>
                  <strong>north_0625</strong>&nbsp;korea is fantastic!
                  <br>
                  <a class="text-muted" style="font-size:1vw">6시간 전</a>
                </p>
    ...
    <aside class="col-md-4 blog-sidebar">
      <div class="p-4 mb-3 bg-light rounded">
        ...
        <div class="row" style="margin-bottom:2em">
            ...
            <div class="col-6">
              <strong>kimhaewonmusic</strong><br><span style="color:grey">Haewon Kim</span>
            </div>
