...
public class HomeController {
	...
	//겟으로 /instaInput이 왔을때 member.jsp로 가주세요.
	@RequestMapping(value = "/member", method = RequestMethod.GET)
	public String memberInput(Locale locale, Model model, String instaId, String picture, String name) {
		
		User memberUser = new User();
		memberUser.setInstaId(instaId);
		memberUser.setPicture(picture);
		memberUser.setName(name);
	...
	//겟으로 /memberPage에 왔을때 member.jsp로 가주세요
		/*@RequestMapping(value = "/member", method = RequestMethod.GET)
		public String memberPage(Locale locale, Model model, User instaId) {
			...
			mysql.getConnection();
			//디비에서 리플라이 가지고 오
			ArrayList<User>userList2 = mysql.getSearchId();
			//디비 커넥션 끄
			mysql.getData();
