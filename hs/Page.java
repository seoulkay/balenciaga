...
public class PageUse {
	public static void main(String[] args) {
		...
		//페이지를 만들고 
		Page myPage = new Page("미스 포츈, 현상금 사냥꾼", "Miss Fortune, The Bounty Hunter","원거리,둔화", 750, 3150);
		//리플을 만들고
		...
		Page myPage1 = new Page("가렌,데마시아의 힘","Garen, The Might of Demacia","전사,탱커,침묵",260,450);
		//리플을 만들고
		...
		Page myPage2 = new Page ("그라가스, 술취한 난동꾼", "Gragas, The Rabble Rouser","전사,마법사,탈출,밀치기,둔화,기절", 790, 3150);
		Reply r21 = new Reply("스코라","ㅋㅋㅋㅋㅋ",3,"2020-05-01");
		myPage2.replies.add(r21);
		myPage.getRepliesNumber();
		
		Page myPage3 = new Page ("나미, 파도 소환사", "Nami, the Tidecaller","서포터, 마법사, 띄우기, 기절, 치유, 둔화", 880, 4800);
		...
		for(int i = 0 ; i < myPages.size(); i++) {
			...
			System.out.println("특징"+"-"+myPages.get(i).desc+"|"+"평점:"+myPages.get(i).getRepliesAvr());
