...
<main role="main" class="container">
  <div class="row">
 	 <h1>로그인 페이지다!</h1>
 	  ...
 	  <div class="row">
 	 <form action="loginInput" class="form-inline">
 	 	<i class="fas fa-search" aria-hidden="true"></i>
 	 	<input type="text" placeholder="InstaID" aria-label="instaid" name="instaId">
 	 	<input type="text" placeholder="Name" aria-label="name" name="name">
 	 	<input type="text" placeholder="PassWord" aria-label="passWord" name="passWord">
 	 	<input type="submit">
 	 </form>
 	 </div>
