  ...
  <div class="row">
            ...
            <div class="row">
                <div class="col-3">
				 ...
				 <div class="row">
				 	...
				 	<div class="col-11">
				 	  Liked by <strong>${po.likeInstaId}</strong> and <strong>${post.likeNumber} others</strong>
					</div>
			   	</div>
			   			<div class="row">
    ...
    <aside class="col-md-4 blog-sidebar">
     	 <div class="p-4 mb-3 bg-light rounded">
		               ...
		               <div class="row">
		                    <div class="col-3">
		                        <img src="resources/${me.picture }" alt="Avatar" width=50em style="border-radius: 50%;">
		                    </div>
		                    <div class="col-6">
		                        <strong>${me.instaId }</strong><br><span style="color:grey">${me.name }</span>
		                    </div>
		                    <div class="col-3">
