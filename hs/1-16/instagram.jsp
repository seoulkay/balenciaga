          ...
          <div class="card mb-4 shadow-sm">
            ...
            <div class="row" style="padding:1em">
                ...
                <div class="col-8" style="margin-top:0.7em;">
                    <a href="" style="color:black">&nbsp;${post.postId }</a>
                </div>
                <div class="col-2">
                    <h2>...</h2>
                </div>
				 ...
				 <div class="row">
				 	...
				 	<div class="col-11">
				 	  Liked by <strong>starzinsue</strong> and <strong>${post.likeNumber} others</strong>
			   			...
			   			<div class="row">
	              		  <p class="card-text"><strong>${post.postId }</strong>${post.description} }</p>
	              		  </div>
	               		  <div class="row">
	               		  <a href="" style="color:grey"> View all ${post.replyTotal } comments</a> 
	               		  </div>
