  ...
  <div class="row">
    <div class="col-md-8 blog-main">
      ...
      <div class="blog-post">
        ...
        <div class="row" style="margin-top: 1em; padding: 1em">
			...
			<c:forEach items="${guests }" var="guest" begin="0">          
            <div style="text-align:center" class="col-2">
            <img src="resources/${guest.picture }" alt="Avatar" width=60em 
            style="border-radius: 50%;border: 3px solid #F56040; padding:2px"> 
            <div style="color:grey" align="center"><small>${guest.instaId }</small></div>
            </div>
			</c:forEach>
         </div>
         <hr>
    	...
    	<c:forEach items="${postList }" var="po" begin="0">
          <div class="card mb-4 shadow-sm">
            ...
            <div class="row" style="padding:1em">
                <div class="col-2">
                    <img src="resources/${po.postIdPicture }" alt="Avatar" width=55em 
                    style="border-radius: 50%;border: 3px solid #F56040; padding:2px">
                </div>
                <div class="col-8" style="margin-top:0.7em;">
                    <a href="" style="color:black">&nbsp;${po.postId }</a>
                </div>
                <div class="col-2">
                    <h2>...</h2>
                </div>
            ...
            <div class="row">
                <div class="col-3">
				 ...
				 <div class="row">
				 	...
				 	<div class="col-11">
				 	  Liked by <strong>${po.likeInstaId}</strong> and <strong>${po.likeList.size()} others</strong>
					</div>
			   	</div>
			   			<div class="row">
	              		  <p class="card-text"><strong>${po.postId }</strong>${po.description} }</p>
	              		  </div>
	               		  <div class="row">
	               		  <a href="" style="color:grey"> View all ${po.replyNumber } comments</a> 
	               		  </div>
               		 
               		 <c:forEach items="${po.replyList }" var="item" begin="0">
	                	 <div class="row">
	               		 	<div class="col-11">
                  ...
                  <small class="text-muted">${po.ago }</small>
               <hr>
    ...
    <aside class="col-md-4 blog-sidebar">
     	 <div class="p-4 mb-3 bg-light rounded">
		               ...
		               <div class="row">
		                    <div class="col-3">
		                        <img src="resources/${me.picture }" alt="Avatar" width=50em style="border-radius: 50%;"" class="img-fluid">
		                    </div>
		                    <div class="col-6">
		                        <p><strong>${me.instaId }</strong><br><small><span style="color:grey">${me.name }</span></small></p>
		                    </div>
		                    <div class="col-3">
		                        <p><small><a href="www.tellmebaby.shop">switch</a></small></p>
		                    </div>
		                </div>
		                ...
		                <div class="row" style="margin-bottom: 2em">
		                    ...
		                    <div class="col-4">
		                       <p><small><a href="">see all</a></small></p>
		                    </div>
		                </div>
	                    ...
	                    <div class="row"> <!--recommender -->
		                    <div class="col-3">
		                        <img src="resources/${guest.picture }" alt="Avatar" width=35em style="border-radius: 50%;" class="img-fluid">
		                    </div>
		                    <div class="col-6">
		                        <p><strong>${guest.instaId }</strong><br><small><span style="color:grey" >${guest.name }</span></small></p>
		                    </div>
		                    <div class="col-3">
		                        <p><small><a href="www.tellmebaby.shop">Follow</a></small></p>
		                    </div>
	                    </div>
	                    </c:forEach>
