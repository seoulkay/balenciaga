    ...
    <div class="col-md-8 blog-main">
      ...
      <div class="blog-post">
        ...
        <div class="row" style="margin-top: 1em; padding: 1em">
            ...
            <img src="resources/img_avatar.jpeg" alt="Avatar" width=55em style="border-radius: 50%;border: 3px solid #F56040; padding:2px"> <span style="color:grey;font-size: 1vw">son</span>
            </div>
        ...
        <div class="col-md-12">
          <div class="card mb-4 shadow-sm">
            ...
            <div class="row" style="padding:1em">
                <div class="col-2">
                    <img src="resources/img_avatar.jpeg" alt="Avatar" width=55em style="border-radius: 50%;border: 3px solid #F56040; padding:2px">
                </div>
            ...
            <img src="resources/main_insta.png">
            ...
            <div class="row">
              ...
              <p class="card-text"><strong>louisvuitton</strong>
                Brushstrokes in thread. <a href="">#JoshSmith’s</a> signature canvases inspired his Louis Vuitton <a href="">#ArtyCapucines,</a> with extensive stitching replicating a painterly effect. Discover <a href="">#LouisVuitton’s</a> limited-edition artistic collaboration via link in bio</p>
...
<div class="row">
    ...
    <aside class="col-md-4 blog-sidebar">
      <div class="p-4 mb-3 bg-light rounded">
               ...
               <div class="row">
                    <div class="col-3">
                        <img src="resources/img_avatar.jpeg" alt="Avatar" width=50em style="border-radius: 50%;">
                    </div>
                    <div class="col-6">
                        <strong>tellmebaby</strong><br><span style="color:grey">tellmebaby</span>
                    </div>
                    <div class="col-3">
                        <a href="www.tellmebaby.shop">switch</a>
                    </div>
                </div>
                ...
                <div class="row" style="margin-bottom: 2em">
                 ...
                 <div class="row">
                    ...
                    <div class="col-6">
                        <strong>ilhwan4343</strong><br><span style="color:grey; font-size:1vw">New to instagram</span>
                    </div>
                    <div class="col-3">
                        <a href="www.tellmebaby.shop">Follow</a>
                    </div>
                    ...
                    <div class="col-6">
                        <strong>Haewon7979</strong><br><span style="color:grey; font-size:1vw">Follow you</span>
                    </div>
                    <div class="col-3">
                        <a href="www.tellmebaby.shop">Follow</a>
                    </div>
                    ...
                    <div class="row" style="margin-bottom:1em">
                        <div class="col-12" style="font-size:0.7vw;color:grey">
                            Abou - Help - Press - API - Jobs - Privacy - Teras <br>
